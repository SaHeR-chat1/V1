...
/* التنسيق الموحد لكل زر (حجم كبير، حواف دائرية، تأثير ضغط) */
.th-grid-btn {
    flex: 1;
    display: flex;
...
/* تكبير الأيقونات وتوسيطها فوق النص داخل الزر */
.th-grid-btn .fa {
...
/* تأثير جميل عند تمرير الماوس أو الضغط بالإصبع */
.th-grid-btn:hover {
...
/* تخصيص ألوان الأزرار الأربعة بالثيم الأزرق النيلي المتدرج الجديد */
