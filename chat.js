...
$(`
  <center>
    <div id="sultan13"> 
      <a id="ahmed21" style="width: 85px; padding: 1px; border-radius: 0px 0px 0px 15px!important; height: 22px;" class="btn minix btn-primary" target="_blank" href="/rules.html">القوانين</a> 
      <a id="ahmed21" style="width: 85px; padding: 1px; height: 22px;" class="btn minix btn-primary" target="_blank" href="FAQ.html">الاسئلة</a> 
      <a id="ahmed21" style="width: 85px; padding: 1px; height: 22px;" class="btn minix btn-primary" target="_blank" href="/subs.html">الاشتراكات</a> 
      <a id="ahmed21" style="border-radius: 0px 0px 15px 0px!important; width: 85px; padding: 1px; height: 22px;" class="btn minix btn-primary" target="_blank" href="contact.html">اتصل بنا</a> 
    </div>
  </center>
